...
function updateAnswer() {
    const answers = [
        ...
        'לא. הם לא מוכנים לשלם את המחירים של הטיסות לנתב"ג',
        'לא. כי הם יודעים שבסוף יזמינו אותם להתווכח בפאנל בחדשות, ואף אחד לא מוכן לזה',
        'לא. הם עדיין מחפשים איך מבטאים "חומוס" בצורה נכונה',
        'לא. הם חוששים שנתלונן שההתקפה לא הייתה מספיק טובה ונדרוש החזר',
        'לא. הם הבינו שברגע שהם יתקרבו, הם יתקעו בפקקים'
    ];
